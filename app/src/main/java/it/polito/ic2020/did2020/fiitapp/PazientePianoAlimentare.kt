...
import kotlinx.android.synthetic.main.paziente_pianoalimentare.recyclerViewDiarioPaz
import kotlinx.android.synthetic.main.paziente_pianoalimentare.topAppBar

class PazientePianoAlimentare : Fragment(R.layout.paziente_pianoalimentare) {
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        recyclerViewDiarioPaz.adapter = AdapterGiorniSettimana(dbData, false)
